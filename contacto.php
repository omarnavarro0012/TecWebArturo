...
<body>
        ...
        <div class="navegacion">
            <nav class="navs">
                ...
                <ul>
                    ...
                    <li><a href="productosPostre.php">Cupcakes</a> </li>
                    <li><a href="productosPostre.php">Pasteles</a> </li>
                    <li><a href="productosPostre.php">Frappes</a> </li>
    ...
    <section>
        <div class="nosotros">
            ...
            <h3>
                ...
                Contacto:
                <br>
                Cel. (WhatsApp) 044.444.122.87.75
                <br>
                Correo: hola@muchocorazon.com.mx
                <br>
                muchocorazonslp@gmail.com
                <br>
                Direccion
                <br>
                Valentín Amador #1044-A
                <br>
                Col. Insurgentes, CP. 78319
                <br>
    ...
    <div class="logos">
            <a href="#"><img src="./Imagenes_del_Proyecto/facebook.png" alt="Facebook icon"></a>
